...
Revision ID: f05a88048a1a
Revises: 
Create Date: 2024-03-27 21:04:04.619881
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['restaurant_id'], ['restaurants.id'], name=op.f('fk_pizzas_restaurant_id_restaurants')),
    sa.PrimaryKeyConstraint('id')
    )
